...
from kernelboard.lib.status_code import HttpStatusCode, error, success
...
def handle_api_http_exception(e):
    return error(message=e.description, code=10000 + e.code, status_code=e.code)


@api.route("/about")
def get_about():
    return success(data={"message": "Kernelboard, your friendly leaderboard."})
